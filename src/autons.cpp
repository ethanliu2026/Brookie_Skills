...
void skills() {
  ...
  chassis.drive_to_point(21.9, -26, 0, 8, 6, 7, 500, 650); //drive to three pile, -27
  chassis.turn_to_point(10.8, -14.4, 0, 5, 2, 300, 450); //turn to low goal
  straightline_to_pose(10.8, -14.4, 18, 3, 0.5, 450, 650); //drive to low goal
  intake_lift = true;
