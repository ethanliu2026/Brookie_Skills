...
void skills() {
  ...
  chassis.drive_to_point(55., -30, 0, 5, 6, 7, 500, 650); //back to right of goal
  chassis.turn_to_angle(180, 8, 1, 300, 380);
  straightline_to_pose(55., 30, 10, 0, 1, 800, 920, true);
  ...
  chassis.drive_to_point(0, -67, 10.5, 12.5, 7, 1, 400, 500);
